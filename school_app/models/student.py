...
class Student(models.Model):
    ...
    photo = fields.Image(max_width=50, max_height=100)
    address = fields.Text()
    state = fields.Selection([('draft', 'Draft'), ('confirm', 'Confirm')])
    course_id=fields.Many2many('school_course',string="Course")
    partner_ids=fields.Many2many('school.professor','student_professor_relation_table','student','professor',string='professor')
    professor=fields.Many2many('school.professor','student_professor_table','students_ids','professor_ids',string='professors')
